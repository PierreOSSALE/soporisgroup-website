...
import RealisationDetailSkeleton from "@/components/skeletons/RealisationDetailSkeleton";
...
export default function RealisationDetail() {
  ...
  if (isLoading) {
    return <RealisationDetailSkeleton />;
  }
  ...
  return (
    <>
      ...
      <section className="py-12 bg-background w-full lg:px-30">
        <div className="md:container mx-auto px-3 md:px-4">
          <AnimatedSection>
            <div className="flex items-center max-w-sm gap-2 mb-4 md:my-4">
              <Link
                href="/realisations"
            ...
            <h1 className="font-display text-center md:text-start text-4xl sm:text-5xl font-bold text-primary mb-6">
              {project.title}
            </h1>
